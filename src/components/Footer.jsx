...
const Footer = () => {
  ...
  return (
    <footer ref={containerRef} className="relative bg-[#050505] pt-32 pb-12 overflow-hidden">
      ...
      {/* 1. Deep Atmosphere (Brand Dark Mode) */}
      <div className="absolute inset-0 pointer-events-none select-none overflow-hidden">
         {/* Deep Gradient Base - Reverted to Black matches Navbar/Support */}
         <div className="absolute inset-0 bg-gradient-to-b from-[#050505] via-[#0A0A0A] to-[#050505] z-0"/>
         
         {/* Subtle Grid Pattern - Neon Lime Accent (#effc76) - Low Opacity */}
         ...
         {/* Subtle Ambient Light - Brand Lime Accents */}
         <motion.div 
