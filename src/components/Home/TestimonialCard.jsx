...
const TestimonialCard = ({ name, role, company, image, text, rating, delay }) => {
    return (
        <motion.div
            ...
            className="bg-[#111] border border-white/5 rounded-2xl p-8 relative group hover:border-[#d946ef]/20 transition-colors duration-300"
        >
            ...
            <div className="relative z-10 flex flex-col h-full justify-between">
                <div>
                    <div className="flex justify-between items-start mb-6">
                        <div className="w-12 h-12 rounded-full overflow-hidden border-2 border-[#d946ef]/20 p-0.5">
                            <img
                                src={image}
                                alt={name}
                        ...
                        <div className="opacity-100">
                            <svg
                                ...
                                stroke="currentColor"
                                strokeWidth="1"
                                className="text-transparent bg-clip-text bg-gradient-to-r from-[#d946ef] to-[#f97316]"
                            >
                    ...
                    <div className="flex gap-1 mb-4">
                        {[...Array(rating)].map((_, i) => (
                            <Star key={i} size={14} className="text-transparent bg-clip-text bg-gradient-to-r from-[#d946ef] to-[#f97316] fill-[#d946ef]" />
                        ))}
                    </div>
                ...
                <div>
                    <h4 className="text-white font-medium text-base">
                        {name} <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#d946ef] to-[#f97316] mx-1">•</span>{" "}
