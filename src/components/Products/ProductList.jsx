  ...
  return (
    <section className="bg-transparent py-24 px-4 md:px-8 relative overflow-hidden">
        ...
        <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
            <div className="absolute top-[20%] left-[10%] w-[500px] h-[500px] bg-gradient-to-r from-[#d946ef] to-[#f97316] rounded-full blur-[100px]" />
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="mb-20 text-center md:text-left">
          ...
          >
            <Sparkles className="w-4 h-4 text-transparent bg-clip-text bg-gradient-to-r from-[#d946ef] to-[#f97316]" />
          ...
          >
            Built for <span className="text-transparent bg-clip-text bg-gradient-to-r from-white to-gray-500">Scale</span> & <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#d946ef] to-[#f97316]">Performance</span>
          </motion.h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mt-16">
          {products.map((product, index) => (
            <Link href={product.link} key={index} className="block group">
              ...
              >
                  {/* Glass Card */}
                  <div className="relative h-full bg-[#0A0A0A]/80 backdrop-blur-xl border border-white/10 rounded-[32px] p-8 md:p-12 overflow-hidden transition-all duration-500 group-hover:border-[#d946ef]/50 group-hover:shadow-[0_0_50px_-15px_rgba(217,70,239,0.2)]">
                      ...
                      <div className="relative z-10">
                          <h3 className="text-3xl font-bold text-white mb-4 group-hover:text-transparent bg-clip-text bg-gradient-to-r from-[#d946ef] to-[#f97316] transition-colors duration-300">
                              {product.title}
                          </h3>
                          ...
                          <div className="flex flex-wrap gap-3 mb-10">
                              {product.features.map((feature, i) => (
                                  <span key={i} className="px-3 py-1 rounded-lg bg-white/5 border border-white/10 text-xs md:text-sm text-gray-300 flex items-center gap-1.5">
                                      <Zap size={12} className="text-transparent bg-clip-text bg-gradient-to-r from-[#d946ef] to-[#f97316]" />
                                      {feature}
                                  </span>
                              ))}
                          </div>
                          ...
                          {/* CTA */}
                          <div className="flex items-center text-transparent bg-clip-text bg-gradient-to-r from-[#d946ef] to-[#f97316] font-semibold tracking-wide group/btn">
                      ...
                      {/* Decorative Shapes */}
                      <div className="absolute -bottom-24 -right-24 w-64 h-64 bg-gradient-to-br from-white/5 to-transparent rounded-full blur-3xl group-hover:bg-gradient-to-r from-[#d946ef] to-[#f97316] transition-colors duration-500" />
                  </div>
              </motion.div>
            </Link>
          ))}
