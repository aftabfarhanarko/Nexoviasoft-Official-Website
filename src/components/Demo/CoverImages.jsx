  ...
  return (
    <section className="w-full pt-6 md:pt-24 flex justify-center px-4 sm:px-6 lg:px-8 pb-24 -mt-20 relative z-20">
      <div className="absolute inset-x-0 -top-10 bottom-0 max-w-6xl mx-auto pointer-events-none">
        <div className="h-full w-full bg-[radial-gradient(circle_at_top,_rgba(217,70,239,0.25),_transparent_55%),radial-gradient(circle_at_center,_rgba(148,163,184,0.22),_transparent_55%),radial-gradient(circle_at_bottom,_rgba(15,23,42,0.9),_transparent_65%)] blur-2xl md:blur-3xl opacity-70 md:opacity-90" />
      </div>
      <div className="relative w-full max-w-6xl mx-auto">
        <div className="relative group">
          <div className="absolute -inset-[1px] rounded-[26px] bg-gradient-to-r from-[#d946ef]/70 via-white/40 to-transparent opacity-70 group-hover:opacity-100 group-hover:blur-[22px] blur-[18px] transition-all duration-700" />
